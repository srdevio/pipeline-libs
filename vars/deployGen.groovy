...
//  sh 'printenv'
  ...
  hipchatSend (color: 'YELLOW', credentialId: 'qaNc1SSn60HyK0FVk09j1ZQ9yOfn9uubScUarD01', failOnError: false, message: 'test', notify: true, room: '4018492', sendAs: 'Jenkins', server: 'api.hipchat.com', textFormat: true, v2enabled: false)
}
