...
def call(data, env) {
  ...
  hipchatSend (color: 'YELLOW', credentialId: 'rgifford-hipchat-api-send-only2', failOnError: false, message: "Just deployed ${service_name}:${tag_id} to ${env}. Thought you should know.  ${data.BLUE_OCEAN_URL}", notify: true, room: '4018492', sendAs: 'Jenkins', server: 'api.hipchat.com', textFormat: true, v2enabled: true)
}
