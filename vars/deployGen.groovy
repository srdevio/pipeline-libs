...
//  sh 'printenv'
  ...
  // Tell hipchat all about it - currently a private room for testing. 
  hipchatSend (color: 'YELLOW', credentialId: 'rgifford-hipchat-api-send-only2', failOnError: false, message: "Just deployed ${service_name}:${tag_id} to ${env}. Thought you should know.", notify: false, room: '4018492', sendAs: 'Jenkins', server: 'api.hipchat.com', textFormat: true, v2enabled: true)
}
